    ...
    return (
      <button
        ...
        className={cn(
          ...
          value ? 'bg-primary' : 'bg-slate-400 dark:bg-slate-600',
          className,
        )}
        {...props}
      >
        <span
          className={cn(
            'pointer-events-none block h-4 w-4 rounded-full bg-background dark:bg-slate-200 shadow-lg ring-0 transition-transform',

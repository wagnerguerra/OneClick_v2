...
\restrict zyksrR0e1pCY3JtNQRPQ9pFdBQtZQFcFbVUv9l0nJNOT52ndq66U5Wpk42G6nKH
...
--
-- Name: EstadoCivil; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: TipoFornecedor; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: TipoSocio; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public."TipoSocio" AS ENUM (
    'SOCIO_ADMINISTRADOR',
    'SOCIO_QUOTISTA',
    'SOCIO_DIRETOR',
    'ACIONISTA',
...
--
-- Name: colaborador_events; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.colaborador_events (
    id text NOT NULL,
...
CREATE TABLE public.colaboradores (
    ...
    sexo public."Sexo",
    estado_civil public."EstadoCivil",
    ...
    cidade text,
    uf character(2),
    tipo_contrato public."TipoContrato" DEFAULT 'CLT'::public."TipoContrato" NOT NULL,
    data_admissao timestamp(3) without time zone,
    data_demissao timestamp(3) without time zone,
...
--
-- Name: colaboradores_code_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.colaboradores_code_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: colaboradores_code_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.colaboradores_code_seq OWNED BY public.colaboradores.code;
...
--
-- Name: fornecedor_events; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.fornecedor_events (
    id text NOT NULL,
...
CREATE TABLE public.fornecedores (
    ...
    inscricao_estadual text,
    inscricao_municipal text,
    tipo_fornecedor public."TipoFornecedor" DEFAULT 'AMBOS'::public."TipoFornecedor" NOT NULL,
    categoria text,
    logo_url text,
    telefone text,
    celular text,
...
--
-- Name: fornecedores_code_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.fornecedores_code_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: fornecedores_code_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.fornecedores_code_seq OWNED BY public.fornecedores.code;
...
--
-- Name: situacao_fiscal; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.situacao_fiscal (
    id text NOT NULL,
    documento text NOT NULL,
    tipo_documento integer DEFAULT 2 NOT NULL,
    razao_social text,
    protocolo text,
    ...
    data_validade timestamp(3) without time zone,
    pdf_base64 text,
...
--
-- Name: socio_arquivos; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.socio_arquivos (
    id text NOT NULL,
...
--
-- Name: socio_events; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.socio_events (
    id text NOT NULL,
    socio_id text NOT NULL,
    user_id text,
    type text NOT NULL,
...
--
-- Name: socio_mensagens; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.socio_mensagens (
    id text NOT NULL,
    socio_id text NOT NULL,
    user_id text,
    mensagem text NOT NULL,
...
CREATE TABLE public.socios (
    ...
    cidade text,
    uf character(2),
    tipo_socio public."TipoSocio" DEFAULT 'SOCIO_QUOTISTA'::public."TipoSocio" NOT NULL,
    participacao numeric(10,4),
    valor_quotas numeric(14,2),
    data_entrada timestamp(3) without time zone,
    data_saida timestamp(3) without time zone,
    assina_na_empresa boolean DEFAULT false NOT NULL,
...
--
-- Name: socios_code_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.socios_code_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: socios_code_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.socios_code_seq OWNED BY public.socios.code;
...
--
-- Name: colaboradores code; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.colaboradores ALTER COLUMN code SET DEFAULT nextval('public.colaboradores_code_seq'::regclass);
...
--
-- Name: fornecedores code; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fornecedores ALTER COLUMN code SET DEFAULT nextval('public.fornecedores_code_seq'::regclass);


--
-- Name: socios code; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.socios ALTER COLUMN code SET DEFAULT nextval('public.socios_code_seq'::regclass);
...
cmnxgb7vx0000w074ew4nwua7	brasilapi	/cnpj/v1/32401481000133	GET	500	842	32401481000133	\N	\N	2026-04-13 17:13:04.941
cmnxglq0m0000w0wc0qskgvnx	brasilapi	/cnpj/v1/32401481000133	GET	200	845	32401481000133	\N	\N	2026-04-13 17:21:14.983
cmnxgm5ds0001w0wccubekm7u	brasilapi	/cnpj/v1/32401481000133	GET	200	247	32401481000133	\N	\N	2026-04-13 17:21:34.91
cmnxgm7vu0002w0wcom4lvz78	brasilapi	/cnpj/v1/32401481000133	GET	200	66	32401481000133	\N	\N	2026-04-13 17:21:38.154
cmnxiue3t0000w0xskjbckv81	serpro	/consulta-cnpj-df/v2/empresa/32401481000133	GET	200	1351	32401481000133	\N	\N	2026-04-13 18:23:58.679
cmnxj43620000w0bk1fy8jxzm	serpro	/consulta-cnpj-df/v2/basica/32401481000133	GET	200	640	32401481000133	\N	\N	2026-04-13 18:31:31.08
cmnxjk51o0000w0901e703als	serpro	/consulta-cnpj-df/v2/empresa/32401481000133	GET	200	1003	32401481000133	\N	\N	2026-04-13 18:44:00.006
cmnxjk86u0001w090scxbuh69	serpro	/consulta-cnpj-df/v2/empresa/32401481000133	GET	200	215	32401481000133	\N	\N	2026-04-13 18:44:04.087
cmnxl0n1y0002w0l451boqaje	integra-contador	/SITFIS	POST	500	\N	32401481000133	WpNpMLBUja8nt6tSHEQvToepffsHTGZS	\N	2026-04-13 19:24:49.462
cmnxmlx240002w0bo4nca687c	integra-contador	/SITFIS	POST	500	\N	11318082000133	WpNpMLBUja8nt6tSHEQvToepffsHTGZS	\N	2026-04-13 20:09:21.82
cmnxnbkx50002w0a83v1k6chp	integra-contador	/Emitir (SITFIS)	POST	500	\N	11318082000133	WpNpMLBUja8nt6tSHEQvToepffsHTGZS	\N	2026-04-13 20:29:19.145
cmnxnjfkt0002w0wgrnwv500z	integra-contador	/SITFIS	POST	500	\N	11318082000133	WpNpMLBUja8nt6tSHEQvToepffsHTGZS	\N	2026-04-13 20:35:25.469
cmnxo1wu00002w0ic3n7x0o7p	integra-contador	/SITFIS	POST	500	\N	11318082000133	WpNpMLBUja8nt6tSHEQvToepffsHTGZS	\N	2026-04-13 20:49:47.641
\.
...
--
-- Data for Name: colaborador_events; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.colaborador_events (id, colaborador_id, user_id, type, version, changes, created_at) FROM stdin;
\.
...
COPY public.colaboradores (id, code, nome_completo, cpf, rg, orgao_emissor, data_nascimento, sexo, estado_civil, nacionalidade, naturalidade, foto_url, pis, ctps, ctps_serie, titulo_eleitor, reservista, email, telefone, celular, cep, logradouro, numero, complemento, bairro, cidade, uf, tipo_contrato, data_admissao, data_demissao, salario, carga_horaria, incluir_ferias, observacoes, empresa_id, area_id, cargo_id, user_id, is_active, version, created_at, updated_at) FROM stdin;
\.
...
--
-- Data for Name: fornecedor_events; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.fornecedor_events (id, fornecedor_id, user_id, type, version, changes, created_at) FROM stdin;
\.
...
COPY public.fornecedores (id, code, razao_social, nome_fantasia, documento, tipo_documento, inscricao_estadual, inscricao_municipal, tipo_fornecedor, categoria, logo_url, telefone, celular, email, site, contato_principal, cargo_contato, cep, logradouro, numero, complemento, bairro, cidade, uf, banco, agencia, conta, tipo_conta, pix_chave, pix_tipo, observacoes, empresa_id, is_active, version, created_at, updated_at) FROM stdin;
\.
...
kk5LJp7o12h9tVlrJWg9SH7p0Q5rtxfK	WpNpMLBUja8nt6tSHEQvToepffsHTGZS	vCUVaRaq0ihLb41i65OMzeSxp8bo7nXS	2026-04-18 19:20:31.62		Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36	2026-04-11 19:20:31.622	2026-04-11 19:20:31.622
6VcsRCHfVJJ1ZhlJHhx2hRBcXhqMOlJf	WpNpMLBUja8nt6tSHEQvToepffsHTGZS	eBFkioC6881s3WrX0leCSosjr5YMrwOG	2026-04-18 19:20:34.081		Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36	2026-04-11 19:20:34.081	2026-04-11 19:20:34.081
K2fFnkcuPCS0lZOyir9D9ztjN6iML9jD	WpNpMLBUja8nt6tSHEQvToepffsHTGZS	VINWLxmQOIr6JA4GgZfI6UWPingANe4Y	2026-04-20 14:23:26.369		Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36	2026-04-13 14:23:26.371	2026-04-13 14:23:26.371
zE1RbOjoPIGw1BimIoVWVVyV9UBb7Prj	WpNpMLBUja8nt6tSHEQvToepffsHTGZS	Dt9wVBZXMTqT09IztMPzXH41O4VDWzy5	2026-04-20 14:23:34.925		Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36	2026-04-13 14:23:34.925	2026-04-13 14:23:34.925
5pMGTPMh5iL16k8GDIwpkFDxfXOnCWal	WpNpMLBUja8nt6tSHEQvToepffsHTGZS	Rthtgb1fzAg3uKI13gXjWJs6ujb9yex9	2026-04-20 17:12:04.572		Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36	2026-04-13 17:12:04.575	2026-04-13 17:12:04.575
ibq4EfUmx02PghR5VW5mOPypGYDW2maf	WpNpMLBUja8nt6tSHEQvToepffsHTGZS	CKVal6v1maGNrgMkxSoGE4TlpZsdGbtE	2026-04-20 17:32:45.465		Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36	2026-04-13 17:32:45.468	2026-04-13 17:32:45.468
oTlapNpEYUid6ZWYzkmcqEfOw0O1WO79	WpNpMLBUja8nt6tSHEQvToepffsHTGZS	ZWeRgIU1qX9TavLiVdK9ZWIXFdvx4DqW	2026-04-20 19:23:59.184		Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36	2026-04-13 19:23:59.187	2026-04-13 19:23:59.187
\.


--
-- Data for Name: situacao_fiscal; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.situacao_fiscal (id, documento, tipo_documento, razao_social, protocolo, etapa, tipo_certidao, numero_certidao, data_emissao, data_validade, pdf_base64, dados_extraidos, resposta_completa, sucesso, erro, status_http, cliente_id, empresa_id, user_id, created_at, updated_at, deleted_at) FROM stdin;
cmnxo1nwk0001w0ic1o247646	11318082000133	2	\N	protocoloRelatorio:+S7N6c04XNZUVzmxWT7SzpkZA4xeDQC9aJ/JBNDYGodA0RDhCsSPQFHXkF2MMAJG0NoYqMpC2etdvteDdt1hJAaZu/FC+G1pYOtTMYqokKarvRe6DASnbT1FJL2uEhxAQV5UOBwFRK2GSe28B5Ev25jDnzpvVJPhFAOwVPSUtZ1VjQOtN4EZMQ85I1G2vRkp6F8avRRBJhRJmcfoUqtR9ZMOa1KQwEc9oZMnVjwXfRvDIr3OJjSAVA==	erro	\N	\N	\N	\N	\N	\N	\N	f	Erro ao obter o relatório. Tente novamente mais tarde.	\N	\N	\N	WpNpMLBUja8nt6tSHEQvToepffsHTGZS	2026-04-13 20:49:36.068	2026-04-13 20:49:47.618	\N
cmnxl0mev0001w0l41my6l69a	32401481000133	2	\N	\N	erro	\N	\N	\N	\N	\N	\N	\N	f	Protocolo não retornado pelo SERPRO. Status: 200. Resposta: {"contratante":{"numero":"32401481000133","tipo":2},"autorPedidoDados":{"numero":"32401481000133","tipo":2},"contribuinte":{"numero":"32401481000133","tipo":2},"pedidoDados":{"idSistema":"SITFIS","idServico":"SOLICITARPROTOCOLO91","versaoSistema":"2.0","dados":""},"status":200,"responseId":"4c6f821e	\N	\N	\N	WpNpMLBUja8nt6tSHEQvToepffsHTGZS	2026-04-13 19:24:48.627	2026-04-13 19:24:49.452	\N
cmnxmlwl20001w0bo2ku54c2m	11318082000133	2	\N	\N	erro	\N	\N	\N	\N	\N	\N	\N	f	Protocolo não retornado pelo SERPRO. Status: 200. Resposta: {"contratante":{"numero":"32401481000133","tipo":2},"autorPedidoDados":{"numero":"32401481000133","tipo":2},"contribuinte":{"numero":"11318082000133","tipo":2},"pedidoDados":{"idSistema":"SITFIS","idServico":"SOLICITARPROTOCOLO91","versaoSistema":"2.0","dados":""},"status":200,"responseId":"714eda5f	\N	\N	\N	WpNpMLBUja8nt6tSHEQvToepffsHTGZS	2026-04-13 20:09:21.2	2026-04-13 20:09:21.811	\N
cmnxnbc6v0001w0a88d8eefmi	11318082000133	2	\N	protocoloRelatorio:+S7N6c04XNZUVzmxWT7SzpkZA4xeDQC9aJ/JBNDYGodA0RDhCsSPQFHXkF2MMAJG0NoYqMpC2etdvteDdt1hJAaZu/FC+G1pYOtTMYqokKarvRe6DASnbT1FJL2uEhxAQV5UOBwFRK2GSe28B5Ev25jDnzpvVJPhFAOwVPSUtZ1VjQOtN4EZMQ85I1G2vRkp6F8avRRBJhRJmcfoUqtR9ZMOa1KQwEc9oZMnVjwXfRvDIr3OJjSAVA==	concluido	Não identificada	\N	2026-04-13 20:29:19.108	\N	\N	\N	{"dados": null, "status": 500, "mensagens": [{"texto": "Erro ao obter o relatório. Tente novamente mais tarde.", "codigo": "[Erro-Sitfis-ER03] "}], "responseId": "bd0530e8-0686-47c7-bf77-25cd176945ae", "contratante": {"tipo": 2, "numero": "32401481000133"}, "pedidoDados": {"dados": "{\\"protocoloRelatorio\\":\\"protocoloRelatorio:+S7N6c04XNZUVzmxWT7SzpkZA4xeDQC9aJ/JBNDYGodA0RDhCsSPQFHXkF2MMAJG0NoYqMpC2etdvteDdt1hJAaZu/FC+G1pYOtTMYqokKarvRe6DASnbT1FJL2uEhxAQV5UOBwFRK2GSe28B5Ev25jDnzpvVJPhFAOwVPSUtZ1VjQOtN4EZMQ85I1G2vRkp6F8avRRBJhRJmcfoUqtR9ZMOa1KQwEc9oZMnVjwXfRvDIr3OJjSAVA==\\"}", "idServico": "RELATORIOSITFIS92", "idSistema": "SITFIS", "versaoSistema": "2.0"}, "contribuinte": {"tipo": 2, "numero": "11318082000133"}, "autorPedidoDados": {"tipo": 2, "numero": "32401481000133"}, "responseDateTime": "2026-04-13T17:29:01.718Z"}	t	\N	500	\N	\N	WpNpMLBUja8nt6tSHEQvToepffsHTGZS	2026-04-13 20:29:07.825	2026-04-13 20:29:19.114	\N
cmnxnj6sr0001w0wgigs4f5xk	11318082000133	2	\N	protocoloRelatorio:+S7N6c04XNZUVzmxWT7SzpkZA4xeDQC9aJ/JBNDYGodA0RDhCsSPQFHXkF2MMAJG0NoYqMpC2etdvteDdt1hJAaZu/FC+G1pYOtTMYqokKarvRe6DASnbT1FJL2uEhxAQV5UOBwFRK2GSe28B5Ev25jDnzpvVJPhFAOwVPSUtZ1VjQOtN4EZMQ85I1G2vRkp6F8avRRBJhRJmcfoUqtR9ZMOa1KQwEc9oZMnVjwXfRvDIr3OJjSAVA==	erro	\N	\N	\N	\N	\N	\N	\N	f	Erro ao obter o relatório. Tente novamente mais tarde.	\N	\N	\N	WpNpMLBUja8nt6tSHEQvToepffsHTGZS	2026-04-13 20:35:14.09	2026-04-13 20:35:25.439	\N
\.


--
-- Data for Name: socio_arquivos; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.socio_arquivos (id, socio_id, file_name, file_url, file_size, mime_type, vencimento, user_id, created_at) FROM stdin;
\.


--
-- Data for Name: socio_events; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.socio_events (id, socio_id, user_id, type, version, changes, created_at) FROM stdin;
cmnxjk89y0005w0909fadezzj	cmnxjk88l0003w0906eqsaq6u	WpNpMLBUja8nt6tSHEQvToepffsHTGZS	created	1	\N	2026-04-13 18:44:04.198
cmnxjk8ap0009w0909rbjj88x	cmnxjk8af0007w0900zeug5be	WpNpMLBUja8nt6tSHEQvToepffsHTGZS	created	1	\N	2026-04-13 18:44:04.226
\.


--
-- Data for Name: socio_mensagens; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.socio_mensagens (id, socio_id, user_id, mensagem, tipo, created_at, updated_at) FROM stdin;
\.
...
COPY public.socios (id, code, nome_completo, cpf, rg, orgao_emissor, data_nascimento, nacionalidade, estado_civil, profissao, email, telefone, celular, cep, logradouro, numero, complemento, bairro, cidade, uf, tipo_socio, participacao, valor_quotas, data_entrada, data_saida, assina_na_empresa, responsavel_legal, observacoes, empresa_id, cliente_id, is_active, version, created_at, updated_at) FROM stdin;
cmnxjk88l0003w0906eqsaq6u	3	ROSANGELA BELLOTI MUNHAO	80912214791	\N	\N	\N	Brasileira	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	SOCIO_ADMINISTRADOR	\N	\N	1999-03-04 00:00:00	\N	t	f	Importado do QSA (SERPRO) — Qualificação: Sócio-Administrador	\N	cmnq3k9bk000f9gtk2ozho7g6	t	1	2026-04-13 18:44:04.149	2026-04-13 18:44:04.149
cmnxjk8af0007w0900zeug5be	4	MARCELO TADEU CIUFFI MUNHAO	82078742791	\N	\N	\N	Brasileira	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	SOCIO_ADMINISTRADOR	\N	\N	1999-03-04 00:00:00	\N	t	f	Importado do QSA (SERPRO) — Qualificação: Sócio-Administrador	\N	cmnq3k9bk000f9gtk2ozho7g6	t	1	2026-04-13 18:44:04.215	2026-04-13 18:44:04.215
\.
...
COPY public.tenants (id, name, slug, schema, status, created_at, updated_at, stripe_customer_id) FROM stdin;
\.
...
--
-- Name: colaboradores_code_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.colaboradores_code_seq', 1, false);
...
--
-- Name: fornecedores_code_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.fornecedores_code_seq', 1, false);


--
-- Name: socios_code_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.socios_code_seq', 4, true);
...
--
-- Name: colaborador_events colaborador_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.colaborador_events
    ADD CONSTRAINT colaborador_events_pkey PRIMARY KEY (id);
...
--
-- Name: fornecedor_events fornecedor_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fornecedor_events
    ADD CONSTRAINT fornecedor_events_pkey PRIMARY KEY (id);
...
--
-- Name: situacao_fiscal situacao_fiscal_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.situacao_fiscal
    ADD CONSTRAINT situacao_fiscal_pkey PRIMARY KEY (id);


--
-- Name: socio_arquivos socio_arquivos_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.socio_arquivos
    ADD CONSTRAINT socio_arquivos_pkey PRIMARY KEY (id);


--
-- Name: socio_events socio_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.socio_events
    ADD CONSTRAINT socio_events_pkey PRIMARY KEY (id);


--
-- Name: socio_mensagens socio_mensagens_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.socio_mensagens
    ADD CONSTRAINT socio_mensagens_pkey PRIMARY KEY (id);
...
--
-- Name: situacao_fiscal_cliente_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX situacao_fiscal_cliente_id_idx ON public.situacao_fiscal USING btree (cliente_id);


--
-- Name: situacao_fiscal_created_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX situacao_fiscal_created_at_idx ON public.situacao_fiscal USING btree (created_at);


--
-- Name: situacao_fiscal_documento_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX situacao_fiscal_documento_idx ON public.situacao_fiscal USING btree (documento);


--
-- Name: socios_cliente_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX socios_cliente_id_idx ON public.socios USING btree (cliente_id);


--
-- Name: socios_cpf_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX socios_cpf_idx ON public.socios USING btree (cpf);
...
--
-- Name: tenants_stripe_customer_id_key; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: colaborador_events colaborador_events_colaborador_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.colaborador_events
    ADD CONSTRAINT colaborador_events_colaborador_id_fkey FOREIGN KEY (colaborador_id) REFERENCES public.colaboradores(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: colaborador_events colaborador_events_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.colaborador_events
    ADD CONSTRAINT colaborador_events_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: colaboradores colaboradores_area_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.colaboradores
    ADD CONSTRAINT colaboradores_area_id_fkey FOREIGN KEY (area_id) REFERENCES public.areas(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: colaboradores colaboradores_cargo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.colaboradores
    ADD CONSTRAINT colaboradores_cargo_id_fkey FOREIGN KEY (cargo_id) REFERENCES public.cargos(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: colaboradores colaboradores_empresa_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.colaboradores
    ADD CONSTRAINT colaboradores_empresa_id_fkey FOREIGN KEY (empresa_id) REFERENCES public.empresas(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: colaboradores colaboradores_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.colaboradores
    ADD CONSTRAINT colaboradores_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
--
-- Name: fornecedor_events fornecedor_events_fornecedor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fornecedor_events
    ADD CONSTRAINT fornecedor_events_fornecedor_id_fkey FOREIGN KEY (fornecedor_id) REFERENCES public.fornecedores(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: fornecedor_events fornecedor_events_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fornecedor_events
    ADD CONSTRAINT fornecedor_events_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE ONLY public.fornecedores
    ADD CONSTRAINT fornecedores_empresa_id_fkey FOREIGN KEY (empresa_id) REFERENCES public.empresas(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
--
-- Name: situacao_fiscal situacao_fiscal_cliente_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.situacao_fiscal
    ADD CONSTRAINT situacao_fiscal_cliente_id_fkey FOREIGN KEY (cliente_id) REFERENCES public.clientes(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: situacao_fiscal situacao_fiscal_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.situacao_fiscal
    ADD CONSTRAINT situacao_fiscal_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: socio_arquivos socio_arquivos_socio_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.socio_arquivos
    ADD CONSTRAINT socio_arquivos_socio_id_fkey FOREIGN KEY (socio_id) REFERENCES public.socios(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: socio_arquivos socio_arquivos_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.socio_arquivos
    ADD CONSTRAINT socio_arquivos_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: socio_events socio_events_socio_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.socio_events
    ADD CONSTRAINT socio_events_socio_id_fkey FOREIGN KEY (socio_id) REFERENCES public.socios(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: socio_events socio_events_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.socio_events
    ADD CONSTRAINT socio_events_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: socio_mensagens socio_mensagens_socio_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.socio_mensagens
    ADD CONSTRAINT socio_mensagens_socio_id_fkey FOREIGN KEY (socio_id) REFERENCES public.socios(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: socio_mensagens socio_mensagens_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.socio_mensagens
    ADD CONSTRAINT socio_mensagens_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: socios socios_cliente_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.socios
    ADD CONSTRAINT socios_cliente_id_fkey FOREIGN KEY (cliente_id) REFERENCES public.clientes(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: socios socios_empresa_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.socios
    ADD CONSTRAINT socios_empresa_id_fkey FOREIGN KEY (empresa_id) REFERENCES public.empresas(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
\unrestrict zyksrR0e1pCY3JtNQRPQ9pFdBQtZQFcFbVUv9l0nJNOT52ndq66U5Wpk42G6nKH

...
export const navigation: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Entregas e Guias', href: '/acessorias/painel', icon: MailWarning },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Acessórias (integração)', href: '/acessorias', icon: Zap, masterOnly: true },
      { label: 'Divergências Acessórias', href: '/acessorias/divergencias', icon: GitCompareArrows, masterOnly: true },

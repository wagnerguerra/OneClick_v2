...
export function Header({ onOpenMobile }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-[var(--app-header-offset)] items-center justify-between border-b border-border bg-card/80 backdrop-blur-sm px-4 sm:px-6">

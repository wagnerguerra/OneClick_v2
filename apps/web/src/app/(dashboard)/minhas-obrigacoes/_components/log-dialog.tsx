...
// Tom sólido por tipo de evento — deriva do helper STRONG (claro+dark). O
// border-color do STRONG é inerte aqui (o badge não tem largura `border`).
const TIPO_CORES: Record<string, string> = {
  criado: STRONG.slate,
  iniciado: STRONG.blue,
  pausado: STRONG.amber,
  retomado: STRONG.blue,
  passo_concluido: STRONG.emerald,
  passo_reaberto: STRONG.amber,
  comentario: STRONG.indigo,
  anexo: STRONG.violet,

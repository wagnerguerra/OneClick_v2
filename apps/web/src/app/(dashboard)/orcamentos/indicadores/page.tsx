...
import {
  BarChart3, Loader2, Send, ThumbsDown, Coins, CheckCircle2, FileDown, CalendarDays,
} from 'lucide-react'
...
// Default: mês anterior (1º dia ao último dia)
...
export default function IndicadoresOrcamentosPage() {
  ...
  return (
    <div className="space-y-5">
      {/* Header — padrão inline de /orcamentos */}
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1>Indicadores de Orçamentos</h1>
            <p className="text-sm text-muted-foreground">Funil por estágio, conversão e acompanhamento por período</p>
          </div>
        </div>
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-4 gap-4">
            <DonutCard
              title="Aprovados / Liberados / Reprovados"
              slices={[

...
/** Cor de acento das Ferramentas (hub + páginas de ferramenta) = a cor primária
 *  do sistema (var --color-primary, adapta ao tema sozinha). A identidade de
 *  módulo saiu do conteúdo — a cor do bloco vive só na sidebar. O parâmetro
 *  `area` é mantido por compatibilidade de assinatura (já não influi na cor). */
export const colorForArea = (_area: ToolArea): string => 'var(--color-primary)'

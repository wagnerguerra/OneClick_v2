  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-border/60 bg-card p-8 shadow-lg shadow-black/5 dark:shadow-black/20">
        ...
        <button
          type="button"
          className="flex w-full h-11 items-center justify-center gap-3 rounded-lg border border-border bg-background text-sm font-medium text-foreground transition-all hover:bg-accent hover:shadow-sm active:scale-[0.99]"
        >

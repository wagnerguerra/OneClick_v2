...
if (_loadedEnv) {
  console.log(`[worker-gnre] .env carregado de ${_loadedEnv}`);
}
...
const EnvSchema = z.object({
  ...
  GNRE_PY_DIR: z.string().default(defaultPythonDir()),
  /** SQLite com dedupe persistente. Default: <GNRE_PY_DIR>/data/gnre.db */
  GNRE_DB_PATH: z.string().optional(),
